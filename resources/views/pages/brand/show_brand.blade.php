...
<nav class="page-width">
    <div class="address-link">
        <a href="{{URL::to('/')}}" class="link">
            <span>
                Home / 
            </span>
        </a>
        <span class="page-title">Collection / 
            @if (!empty($brand_by_id[0]))
                {{ $brand_by_id[0]->brand_name}}
            @endif
        </span>
    </div>
...
<div class="container_banner">
    <div class="row justify-content-center bannerImage">

        <!-- First Column -->
        <div class="col-12 col-md-6">
            <div class="card-container position-relative text-center">
                <a href="" target="_self">
                    <img src="{{ asset('public/frontend/img/bannerBrand/' . $brand_by_id[0]->brand_name . '2.jpg') }}" alt="Women's Style" class="img-fluid card-image">
                </a>
                <div class="overlayText">
                    <span class="titleCategory">Woman's 
                        {{ $brand_by_id[0]->brand_name}}
                    </span>
        ...
        <div class="col-12 col-md-6">
            <div class="card-container position-relative text-center">
                <a href="" target="_self">
                       <img src="{{ asset('public/frontend/img/bannerBrand/' . $brand_by_id[0]->brand_name . '1.jpg') }}" alt="Man's Style" class="img-fluid card-image">
                </a>
                <div class="overlayText">
                    <span class="titleCategory">Man's 
                         {{ $brand_by_id[0]->brand_name}}
                    </span>
                  <div class="textBorder">
                      <span class="desCategory">Discover</span>
        ...
        <div class="product-items">
            ...
            <div class="item_product">
                ...
                <div class="img_Product">
                    ...
                    <img src="{{URL::to('public/uploads/product/'.$product->product_image)}}" alt="" class="img_Item--2" id="">
                </div>
