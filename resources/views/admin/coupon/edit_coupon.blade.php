            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="status-add">
                     ...
                     @foreach ($edit_coupon as $key => $item)
                        <form method="post" class="form-horizontal" action="{{URL::to('/update-coupon/'.$item->coupon_id)}}">
                        @csrf
                        <div class="form-group"><label class="col-sm-2 control-label">Coupon Name</label>

                            <div class="col-sm-10"><input type="text" class="form-control" name="coupon_name" value="{{$item->coupon_name}}"></div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group"><label class="col-sm-2 control-label">Coupon Code</label>
                            <div class="col-sm-10"><input type="text" class="form-control" name="coupon_code" value="{{$item->coupon_code}}"></div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group"><label class="col-sm-2 control-label">Coupon Quantity</label>
                            <div class="col-sm-10"><input type="text" class="form-control" name="coupon_times" value="{{$item->coupon_times}}">  
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group"><label class="col-sm-2 control-label">Coupon Feature</label>
                            <div class="col-sm-10">
                                <select class="form-control m-b" name="coupon_condition">
                                    ...
                                    <option value="1" selected>Decrease by percentage</option>
                                    <option value="2" >decrease by amount</option>
                                    @else
                                     <option value="1" >Decrease by percentage</option>
                                    <option value="2" selected>decrease by amount</option>
                                     @endif
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Percent or amount of discount</label>
                            <div class="col-sm-10"><input type="text" class="form-control" name="coupon_number"value="{{$item->coupon_number}}" >  
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                ...
                                <button class="btn btn-primary" type="submit" name="edit_coupon">Edit Coupon</button>
                            </div>
                        </div>
                    </form>
                     @endforeach
