        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="ibox-content">
                    <form class="m-t" role="form" action="{{URL::to('/register')}}" method="POST">
                        @csrf  
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Username" required="" value="{{old('admin_name')}}" name="admin_name">
                        </div>
                        <div class="form-group">
                            <input type="email" class="form-control" placeholder="Email" required="" value="{{old('admin_email')}}" name="admin_email">
                        </div>
                         <div class="form-group">
                            <input type="phone" class="form-control" placeholder="PhoneNumber"  value="{{old('admin_phone')}}"   required="" name="admin_phone">
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control" placeholder="Password" required="" name="admin_password">
                        </div>
                        <button name="Register" type="submit" class="btn btn-primary block full-width m-b" style="background-color: black">Register</button>

                        <div class="options" style="display: flex ; justify-content: space-between" >
                            <a href="{{URL::to('/admin')}}">
                            <small>Back</small>
                           </a>
                           <a href="{{URL::to('/login-auth')}}">
                            <small>Login Auth</small>
                           </a>
                        </div>
                    </form>
                    <p class="m-t">
