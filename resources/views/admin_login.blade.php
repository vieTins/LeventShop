            ...
            <div class="col-md-6">
                <div class="ibox-content">
                    <form class="m-t" role="form" action="{{URL::to('admin-dashboard')}}" method="POST">
                        ...
                        <div class="form-group">
                            <input type="email" class="form-control" placeholder="Username" required="" name="admin_email">
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control" placeholder="Password" required="" name="admin_password">
                        </div>
                        <button name="Login" type="submit" class="btn btn-primary block full-width m-b" style="background-color: black">Login</button>
